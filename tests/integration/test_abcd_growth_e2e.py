        ...
        metadata={
            ...
            "method_candidate": {
                ...
                "manifest": {
                    ...
                    "prompt_only": True,
                    "task_family": "prd-to-sop",
                    "applicability": ["prd to sop"],
                    "exclusions": ["quick social post"],
                    "inputs": ["prd", "profile", "evidence"],
                    "outputs": ["sop"],
                    "steps": ["Load profile", "Resolve evidence", "Mark assumptions"],
                    "evidence_rules": ["cite eligible A or published B"],
                    "failure_handling": ["emit research gap"],
                    "trigger_contract": {"positive_signals": ["prd to sop"], "negative_signals": ["quick social post"]},
                    "eval_cases": [
                        {"id": "prd-positive-1", "type": "should_trigger", "prompt": "prd to sop", "expected_method": "prd-to-sop"},
                        {"id": "prd-positive-2", "type": "should_trigger", "prompt": "Convert this PRD to SOP", "expected_method": "prd-to-sop"},
                        {"id": "prd-positive-3", "type": "should_trigger", "prompt": "evidence prd to sop", "expected_method": "prd-to-sop"},
                        {"id": "prd-negative-1", "type": "should_not_trigger", "prompt": "quick social post", "expected_method": ""},
                        {"id": "prd-negative-2", "type": "should_not_trigger", "prompt": "short social post", "expected_method": ""},
                        {"id": "prd-edge", "type": "edge_case", "prompt": "prd to sop but quick social post", "expected_method": ""},
                    ],
                },
            },
        },
